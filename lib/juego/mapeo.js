...
export function mapearJuego(fila, preguntasCargadas) {
  const resultado = {
    ...
    agrupacionVivo: fila.agrupacion_vivo,
...
// Igual que mapearPreguntaBanco pero con id y opciones sueltas (A/B/C/D
// como campos, no anidadas) para la pantalla de editar preguntas.
export function mapearPreguntaEditable(fila) {
  return {
    id: fila.id,
    nivel: fila.nivel,
    pregunta: fila.pregunta,
    opcionA: fila.opcion_a,
    opcionB: fila.opcion_b,
    opcionC: fila.opcion_c,
    opcionD: fila.opcion_d,
    respuestaCorrecta: fila.respuesta_correcta,
  };
}
