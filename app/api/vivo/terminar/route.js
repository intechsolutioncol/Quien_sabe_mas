...
// El host termina el juego en vivo antes de tiempo. Equivalente a
// finalizarSesionVivoManual de Vivo.js.
export async function POST(request) {
  ...
  const { error } = await admin.rpc('vivo_finalizar', { p_codigo: codigoNormalizado });
